var info = require('./data/sat.json');
...
console.log(noTestingInfo); 
 ...
 // overall top 10
let overallScoresTop10 = info.data.sort((a, b) => (b[13] + b[12] + b[11]) - (a[13] + a[12] + a[11])).filter((e, i) => i < 9).map(e => e[9]);
console.log(overallScoresTop10)

 //divergent top 10
let divergencyMathReading = info.data.sort((a ,b) => Math.abs(b[12] - b[11]) - Math.abs(a[12] -a[11])).filter((e, i) => i < 9).map(e => e[9])
